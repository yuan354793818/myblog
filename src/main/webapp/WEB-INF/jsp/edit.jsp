...
<input id="blog_id" type="hidden" value="${blog.blogId}"/>
<h2>标题：<input id="blog_title" type="text" value="${blog.title}" placeholder="请写入标题" style="width: 1100px">&nbsp;<a href="javascript:history.go(-1)" class="btn btn-sm btn-primary">返回</a></h2>
<div>
    <textarea id="editor"  style="width:1200px;height:800px;"></textarea>
</div>
<div id="btns">
    <button onclick="blog_editor.update_commit()">提交</button>
</div>
<textarea style="display:none" id="content">${blog.bContent}</textarea>
